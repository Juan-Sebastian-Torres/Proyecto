...
import static co.com.screenplay.project.ui.HomeProductUI.FIRST_PRODUCT;
import static co.com.screenplay.project.ui.HomeUI.HOME;
...
public class ChooseFirstProductTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        waitting(TIME_SHORT);
        actor.attemptsTo(WaitUntil.the(HOME, isEnabled()).forNoMoreThan(TIME_SHORT).seconds(), Click.on(HOME));
